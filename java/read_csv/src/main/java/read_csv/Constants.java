...
public final class Constants {
	// DB CONSTANTS
	public static final String DB_URL = "jdbc:mysql://localhost:3306/csv_database?useSSL=false";
	...
	public static final String SAVE_COUNT = "SAVE_COUNT"; // key in thread return map, containing count of success save
															// count
	public static final Integer BATCH_LIMIT = 50;
	...
	public static final String UPDATE_MASTER_SQL = "UPDATE master_csv_table SET status = 0 WHERE table_name = %s AND status = 1 ;";
	public static final String SELECT_MASTER_SQL = "SELECT lines_read,lines_saved  FROM master_csv_table WHERE table_name = '%s' AND status = 1 LIMIT 1;";
	public static final String INSERT_MASTER_SQL = "INSERT INTO master_csv (csv_name,table_name,lines_read,lines_saved) VALUE (%s,%s,%s,%s) ;";
	...
	public static final String SELECT_ANALYSIS_SQL = "SELECCT keyword,operation,value FROM csv_analysis WHERE status = 1 AND  table_name = '%s';";
